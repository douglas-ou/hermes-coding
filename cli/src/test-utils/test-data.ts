...
/**
 * Re-export TaskConfig as Task for backward compatibility in test data.
 */
...
export const testTasks = {
  ...
  /**
   * A pending task with unsatisfied dependencies
   */
  blocked: {
...
export const testTaskIndex = {
  ...
  tasks: {
    'setup.scaffold': {
      ...
      module: 'setup',
      description: 'Create project scaffolding',
      filePath: '.hermes-coding/tasks/setup/setup.scaffold.md',
    },
    'auth.login.ui': {
      status: 'in_progress',
      priority: 2,
      module: 'auth',
      description: 'Implement login UI component',
      filePath: '.hermes-coding/tasks/auth/auth.login.ui.md',
    },
    'auth.api.setup': {
      status: 'completed',
      priority: 1,
      module: 'auth',
      description: 'Set up authentication API endpoints',
      filePath: '.hermes-coding/tasks/auth/auth.api.setup.md',
    },
    'auth.protected-routes': {
      ...
      module: 'auth',
      description: 'Implement protected route wrapper',
      filePath: '.hermes-coding/tasks/auth/auth.protected-routes.md',
    },
  },
};
