...
export interface IFileSystem {
  ...
  /**
   * Write data to a new file only if it does not already exist.
   * @param path - Path to the new file
   * @param data - Data to write (string or Buffer)
   * @param options - Write options (encoding, mode)
   */
  writeFileNoClobber(path: string, data: string | Buffer, options?: WriteFileOptions): Promise<void>;
  ...
  /**
   * Rename a file (atomic on most filesystems).
   ...
   * @param oldPath - Current temp path
